...
function UdaciSteppers ({max, unit, step, value, onIncrement, onDecrement}) {
  return (
    <View style={[styles.row, {justifyContent: 'space-between'}]}>
      {Platform.select({
        ios: () => <IosStepper {...{onIncrement, onDecrement}} />,
        android: () => <AndroidStepper {...{onIncrement, onDecrement}} />
      })()}
...
const IosStepper = ({onIncrement, onDecrement}) => (
...
const AndroidStepper = ({onIncrement, onDecrement}) => (
  <View style={{flexDirection: 'row'}}>
